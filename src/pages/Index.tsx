...
const Index = () => {
  ...
  const displayedUseCases = isMobile ? filteredUseCases.slice(0, 5) : filteredUseCases;
  ...
  return <div className="min-h-screen flex flex-col">
        ...
        <div className="container max-w-7xl mx-auto">
          <AnimatedSection>
            <div className="text-center mb-8 md:mb-12">
              ...
              <h2 className="text-2xl md:text-4xl font-bold text-gray-800">End-to-End AI & Data Solutions</h2>
      ...
      <section className="py-16 md:py-24 px-4 md:px-6 bg-tintto-gray" id="use-cases">
        <div className="container max-w-7xl mx-auto">
          <AnimatedSection>
            <div className="text-center mb-8 md:mb-12">
              <span className="inline-block px-4 py-2 rounded-full bg-tintto-blue/10 border border-tintto-blue/20 text-tintto-blue text-sm font-medium mb-4">
              ...
              <h2 className="text-2xl md:text-4xl font-bold text-gray-800">Hundreds of Use Cases</h2>
              <p className="text-gray-600 mt-4 max-w-3xl mx-auto text-sm md:text-base">
          ...
          <div className="flex flex-wrap justify-center gap-2 md:gap-3 mt-6 md:mt-8 overflow-x-auto pb-2 -mx-4 px-4 md:overflow-visible md:pb-0 md:px-0 md:mx-0">
            {filters.map(filter => <button key={filter} className={`bubble-filter text-xs md:text-sm whitespace-nowrap ${activeFilter === filter ? 'active' : ''}`} onClick={() => handleFilterClick(filter)}>
                {filter}
              </button>)}
          </div>

          <div className="use-case-grid mt-6 md:mt-8">
            {displayedUseCases.length > 0 ? displayedUseCases.map((useCase, index) => <UseCaseCard key={index} title={useCase.title} description={useCase.description} tags={useCase.tags} delay={useCase.delay} />) : <div className="col-span-3 text-center py-12">
      ...
      <section className="py-16 md:py-24 px-4 md:px-6" id="about">
        <div className="container max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <AnimatedSection direction="right">
              ...
              <h2 className="text-2xl md:text-4xl font-bold mb-4 md:mb-6 text-gray-800">Our Story</h2>
              ...
              <div className="mb-6 md:mb-8">
                <h3 className="text-lg md:text-xl font-semibold mb-2 md:mb-4 text-gray-800">Our Mission</h3>
      ...
      {/* CTA Section */}
      <section className="py-16 md:py-24 px-4 md:px-6 bg-zinc-100">
        <div className="container max-w-5xl mx-auto text-center">
          <AnimatedSection>
            <h2 className="text-2xl md:text-4xl font-bold mb-4 md:mb-6 text-gray-800">Ready to Transform Your Business?</h2>
